...
public class SubtaskTest {
    ...
    void setUp(){
        ...
        subtask11 = new Subtask("Subtask 1", false, 1);
        subtask2 = new Subtask("Subtask 2", false, 1);
        subtask3 = new Subtask("Subtask 1", true, 1);
        subtask4 = new Subtask("Subtask 1", false, 1);
        subtask5 = new Subtask("Subtask 1", false, 5);
    }

    @Test
    void testConstructor(){
        assertNotNull(new Subtask("Subtask", true, 1));
    ...
    void testHashCode() {
        ...
        assertEquals(subtask1.hashCode(), subtask11.hashCode());
    }

    @Test
    void testToString() {
        String stringSubtask1 = "Subtask{id=0, title='Subtask 1', " +
                "checked=false, position=1}";
        ...
        assertEquals(subtask1.toString(), subtask4.toString());
