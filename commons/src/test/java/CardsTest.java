...
class CardsTest {
    ...
    public void setUp(){
        ...
        Subtask subtask1 = new Subtask("Subtask 1", false, card1);
        Subtask subtask2 = new Subtask("Subtask 2", false, card1);
    ...
    void testToString(){
        String stringCard1 = "Cards{id=0, title='Card 1', positionInsideList=1, " +
                ...
                "cards=, board=Board1}, " +
                "subtasks=[Subtask{id=0, title='Subtask 1', checked=false, card.id=0}]}";
        ...
        String stringCard6 = "Cards{id=0, title='Card 1', positionInsideList=1, " +
                ...
                "list=Lists{id=2, title='list 2', positionInsideBoard=2, " +
                "cards=, board=Board1}, " +
                "subtasks=[Subtask{id=0, title='Subtask 2', checked=false, card.id=0}]}";
