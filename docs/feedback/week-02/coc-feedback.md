...
- It would be great to make your gitlab uploading proccess smoother, by having an admin branch that you always push to or by tagging the relevant commits (the ones that address a deadline).
...
#### Tips:
- Could be a little more exact with how do you plan to communicate with the TA throgh mattermost (one person speaks for the team on the group?).
...
#### Tops:
- Mentiones the minimum that each member has to contribute.
#### Tips:
...
#### Tops:
- Covers a lot of scenarios and is decentely exact.
#### Tips:
...
Feedback: 
- The criteria is good, but you have to have an explanation for each one you wrote.
